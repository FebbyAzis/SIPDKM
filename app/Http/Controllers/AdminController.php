...
class AdminController extends Controller
{
    public function posyandu_nusa_indah()
    {
        ...
        return view('admin.posyandu_nusa_indah', compact('pyb1', 'tmbng1', 'imun1', 'vtmn1'));
    }
    ...
    public function posyandu_dahlia()
    {
        ...
        return view('admin.posyandu_dahlia', compact('pyb2', 'tmbng2', 'imun2', 'vtmn2'));
    }
    ...
    public function posyandu_mawar_merah()
    {
        ...
        return view('admin.posyandu_mawar_merah', compact('pyb3', 'tmbng3', 'imun3', 'vtmn3'));
    }
    ...
    public function posyandu_melati_putih()
    {
        ...
        return view('admin.posyandu_melati_putih', compact('pyb4', 'tmbng4', 'imun4', 'vtmn4'));
    }
    ...
    public function posyandu_aster()
    {
        ...
        return view('admin.posyandu_aster', compact('pyb5', 'tmbng5', 'imun5', 'vtmn5'));
    }
    ...
    public function posyandu_anggrek()
    {
        ...
        return view('admin.posyandu_anggrek', compact('pyb6', 'tmbng6', 'imun6', 'vtmn6'));
    }
