...
@section('content')
    <div class="main-content container-fluid">
        ...
        <div class="card">
          ...
          <h4 class="card-title">Tabel Data Bayi/Balita Posyandu Dahlia</h4>
        </div>
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Penimbangan Posyandu Dahlia</h4>
        </div>
            <div class="card-content">
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Imunisasi Posyandu Dahlia</h4>
        </div>
            <div class="card-content">
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Vitamin Posyandu Dahlia</h4>
        </div>
            <div class="card-content">
