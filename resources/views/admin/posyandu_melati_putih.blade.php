...
@section('content')
    <div class="main-content container-fluid">
        ...
        <div class="page-title">
          <div class="row">
            <div class="col-sm-12">
              <h3>Data Posyandu Melati Putih</h3>
        ...
        <div class="card">
          ...
          <h4 class="card-title">Tabel Data Bayi/Balita Posyandu Melati Putih</h4>
        </div>
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Penimbangan Posyandu Melati Putih</h4>
        </div>
            <div class="card-content">
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Imunisasi Posyandu Melati Putih</h4>
        </div>
            <div class="card-content">
        ...
        <div class="card">
            <div class="card-header">
          <h4 class="card-title">Tabel Data Vitamin Posyandu Melati Putih</h4>
        </div>
            <div class="card-content">
